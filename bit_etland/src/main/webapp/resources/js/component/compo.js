...
compo = {
	...
	prod_post : ()=>{
		return '<div class="container">'
			...
			+'<label><input type="checkbox" value="blue" disabled>블루</label>'
			+'</div>'
			+'<div class="radio">'
			...
			prod_register : ()=>{
				...
				+'<div class="mb-3">'
				  +'<label for="price">수량 <span class="text-muted">(개)</span></label>'
				  +'<input type="text" class="form-control" id="unit" placeholder="가격(만원단위)">'
				  +'<div class="invalid-feedback">'
				+'수량을 등록하세요'
				  +'</div>'
				+'</div>'
				...
				+'<select class="custom-select d-block w-100" id="supplier_id" required="">'
				...
				+'<div class="custom-control custom-checkbox">'
				  +'<input type="checkbox" value="film" class="custom-control-input" id="same-address">'
				  +'<label class="custom-control-label" for="same-address">필름</label>'
				+'</div>'
				+'<div class="custom-control custom-checkbox">'
				  +'<input type="checkbox" value="batter" class="custom-control-input" id="same-address">'
				  +'<label class="custom-control-label" for="same-address">보조배터리</label>'
				+'</div>'
				+'<div class="custom-control custom-checkbox">'
				  +'<input type="checkbox" value="case" class="custom-control-input" id="same-address">'
				...
				+'<input id="credit" value="white" name="color" type="radio" class="custom-control-input" checked="" required="">'
				+'<label class="custom-control-label" for="credit">화이트</label>'
				  +'</div>'
				  +'<div class="custom-control custom-radio">'
				+'<input id="debit" value="black" name="color" type="radio" class="custom-control-input" required="">'
				+'<label class="custom-control-label" for="debit">블랙</label>'
				  +'</div>'
				  +'<div class="custom-control custom-radio">'
				+'<input id="paypal" value="blue" name="color" type="radio" class="custom-control-input" required="">'
				...
				+'</div>'
				+'<hr class="mb-4">'
				+'<button  class="btn btn-primary btn-lg btn-block" id="prod_regi" type="submit">Continue to checkout</button>'
				  +'</div>'
				+'</div>'	
				},
		galaxyImg :()=>{
            ...
            +'<a href="/w3images/lights.jpg" target="_blank">'
              +'<img src="https://img1.daumcdn.net/thumb/R720x0.q80/?scode=mtistory&fname=http%3A%2F%2Fcfile23.uf.tistory.com%2Fimage%2F99BFFD4D5BF20EE9259710">'
              +'<div class="caption">'
		...
		galaxyImg1 :()=>{
            ...
            +'<div class="thumbnail">'
            +'<a href="/w3images/lights.jpg" target="_blank">'
              +'<img src="http://www.newsian.co.kr/news/photo/201903/34750_12639_3710.jpg" alt="Lights" style="width:100%">'
              +'<div class="caption">'
                +'<p>Lorem ipsum donec id elit non mi porta gravida at eget metus.</p>'
              +'</div>'
            +'</a>'
		...
		galaxyImg2 :()=>{
            ...
            +'<div class="thumbnail">'
            +'<a href="/w3images/lights.jpg" target="_blank">'
              +'<img src="https://t1.daumcdn.net/cfile/tistory/99D5BD3A5CA363EB0C">'
              +'<div class="caption">'
                +'<p>Lorem ipsum donec id elit non mi porta gravida at eget metus.</p>'
              +'</div>'
            +'</a>'
